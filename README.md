...
| Retention Retainers | durable evidence only | reconstruction | [retention-retainers](https://github.com/AnarchI-Technologies/retention-retainers) |
...
| Railway | none | paused/obsolete | historical provider only |

Provider deletion is administrative cleanup, not an architectural dependency gate.
